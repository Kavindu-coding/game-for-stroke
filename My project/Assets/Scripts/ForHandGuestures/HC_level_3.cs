...
public class HC_level_3 : MonoBehaviour
{
    public UDPReceive udpReceive;
    public GameObject player;
    private PlayerControlfour playerController;

    void Start()
    {
        playerController = player.GetComponent<PlayerControlfour>();
    }
